...
abstract class BaseTblAdherentQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_ADHERENT`, `ENTRAINEUR_ID`, `CIN_ADHERENT`, `NOM_ADHERENT`, `PRENOM_ADHERENT`, `ID_CIVILITE`, `ID_SITUATION`, `ID_TYPE_ADHERENT`, `NIVEAU_ADHERENT_ID`, `ID_TYPE_SPORT`, `AGE_ADHERENT`, `NUM_TEL`, `ADRESSE_ADHERENT`, `IMAGE_ADHERENT`, `DATE_ADHESION`, `SEANCE_HORAIRE_ID`, `UPDATED_AT`, `DELETED_AT` FROM `tbl_adherent` WHERE `ID_ADHERENT` = :p0';
		try {
