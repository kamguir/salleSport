 ...
 * @method     TblAdherentQuery orderByUserId($order = Criteria::ASC) Order by the user_id column
 * @method     TblAdherentQuery orderByEntraineurId($order = Criteria::ASC) Order by the entraineur_id column
 ...
 * @method     TblAdherentQuery groupByUserId() Group by the user_id column
 * @method     TblAdherentQuery groupByEntraineurId() Group by the entraineur_id column
 ...
 *
 * @method     TblAdherentQuery leftJoinTblUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the TblUser relation
 * @method     TblAdherentQuery rightJoinTblUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the TblUser relation
 * @method     TblAdherentQuery innerJoinTblUser($relationAlias = null) Adds a INNER JOIN clause to the query using the TblUser relation
 *
 * @method     TblAdherentQuery leftJoinTblAdherentRelatedByEntraineurId($relationAlias = null) Adds a LEFT JOIN clause to the query using the TblAdherentRelatedByEntraineurId relation
 * @method     TblAdherentQuery rightJoinTblAdherentRelatedByEntraineurId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the TblAdherentRelatedByEntraineurId relation
 * @method     TblAdherentQuery innerJoinTblAdherentRelatedByEntraineurId($relationAlias = null) Adds a INNER JOIN clause to the query using the TblAdherentRelatedByEntraineurId relation
 *
 ...
 *
 * @method     TblAdherentQuery leftJoinTblAdherentRelatedByIdAdherent($relationAlias = null) Adds a LEFT JOIN clause to the query using the TblAdherentRelatedByIdAdherent relation
 * @method     TblAdherentQuery rightJoinTblAdherentRelatedByIdAdherent($relationAlias = null) Adds a RIGHT JOIN clause to the query using the TblAdherentRelatedByIdAdherent relation
 * @method     TblAdherentQuery innerJoinTblAdherentRelatedByIdAdherent($relationAlias = null) Adds a INNER JOIN clause to the query using the TblAdherentRelatedByIdAdherent relation
 *
 ...
 * @method     TblAdherent findOneByUserId(int $user_id) Return the first TblAdherent filtered by the user_id column
 * @method     TblAdherent findOneByEntraineurId(int $entraineur_id) Return the first TblAdherent filtered by the entraineur_id column
 ...
 * @method     array findByUserId(int $user_id) Return TblAdherent objects filtered by the user_id column
 * @method     array findByEntraineurId(int $entraineur_id) Return TblAdherent objects filtered by the entraineur_id column
...
abstract class BaseTblAdherentQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_ADHERENT`, `USER_ID`, `ENTRAINEUR_ID`, `CIN_ADHERENT`, `NOM_ADHERENT`, `PRENOM_ADHERENT`, `ID_CIVILITE`, `ID_SITUATION`, `ID_TYPE_ADHERENT`, `NIVEAU_ADHERENT_ID`, `ID_TYPE_SPORT`, `AGE_ADHERENT`, `NUM_TEL`, `ADRESSE_ADHERENT`, `IMAGE_ADHERENT`, `DATE_ADHESION`, `SEANCE_HORAIRE_ID`, `UPDATED_AT`, `DELETED_AT` FROM `tbl_adherent` WHERE `ID_ADHERENT` = :p0';
		try {
	...
	/**
	 * Filter the query on the entraineur_id column
	 *
	 * Example usage:
	 * <code>
	 * $query->filterByEntraineurId(1234); // WHERE entraineur_id = 1234
	 * $query->filterByEntraineurId(array(12, 34)); // WHERE entraineur_id IN (12, 34)
	 * $query->filterByEntraineurId(array('min' => 12)); // WHERE entraineur_id > 12
	 * </code>
	 *
	 * @see       filterByTblAdherentRelatedByEntraineurId()
	 *
	 * @param     mixed $entraineurId The value to use as filter.
	 *              Use scalar values for equality.
	 *              Use array values for in_array() equivalent.
	 *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 ...
	 * @return    TblAdherentQuery The current query, for fluid interface
	 */
	public function filterByEntraineurId($entraineurId = null, $comparison = null)
	{
		if (is_array($entraineurId)) {
			$useMinMax = false;
			if (isset($entraineurId['min'])) {
				$this->addUsingAlias(TblAdherentPeer::ENTRAINEUR_ID, $entraineurId['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($entraineurId['max'])) {
				$this->addUsingAlias(TblAdherentPeer::ENTRAINEUR_ID, $entraineurId['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(TblAdherentPeer::ENTRAINEUR_ID, $entraineurId, $comparison);
	}
	...
	public function filterByTblUser($tblUser, $comparison = null)
	{
		if ($tblUser instanceof TblUser) {
			return $this
				->addUsingAlias(TblAdherentPeer::USER_ID, $tblUser->getUserId(), $comparison);
		} elseif ($tblUser instanceof PropelCollection) {
			if (null === $comparison) {
				$comparison = Criteria::IN;
			}
			return $this
				->addUsingAlias(TblAdherentPeer::USER_ID, $tblUser->toKeyValue('PrimaryKey', 'UserId'), $comparison);
		} else {
	 ...
	 * @return    TblAdherentQuery The current query, for fluid interface
	 */
	public function joinTblUser($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
	{
	 ...
	 */
	public function useTblUserQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
	{
		return $this
	 ...
	 * @return    TblAdherentQuery The current query, for fluid interface
	 */
	public function filterByTblAdherentRelatedByEntraineurId($tblAdherent, $comparison = null)
	{
		if ($tblAdherent instanceof TblAdherent) {
			return $this
				->addUsingAlias(TblAdherentPeer::ENTRAINEUR_ID, $tblAdherent->getIdAdherent(), $comparison);
		} elseif ($tblAdherent instanceof PropelCollection) {
			if (null === $comparison) {
				$comparison = Criteria::IN;
			}
			return $this
				->addUsingAlias(TblAdherentPeer::ENTRAINEUR_ID, $tblAdherent->toKeyValue('PrimaryKey', 'IdAdherent'), $comparison);
		} else {
			throw new PropelException('filterByTblAdherentRelatedByEntraineurId() only accepts arguments of type TblAdherent or PropelCollection');
		}
	}

	/**
	 * Adds a JOIN clause to the query using the TblAdherentRelatedByEntraineurId relation
	 *
	 * @param     string $relationAlias optional alias for the relation
	 * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
	 *
	 * @return    TblAdherentQuery The current query, for fluid interface
	 */
	public function joinTblAdherentRelatedByEntraineurId($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
	{
		$tableMap = $this->getTableMap();
		$relationMap = $tableMap->getRelation('TblAdherentRelatedByEntraineurId');
		...
		if($relationAlias) {
			...
			$this->addJoinObject($join, 'TblAdherentRelatedByEntraineurId');
		}
	...
	/**
	 * Use the TblAdherentRelatedByEntraineurId relation TblAdherent object
	 *
	 * @see       useQuery()
	 *
	 * @param     string $relationAlias optional alias for the relation,
	 ...
	 */
	public function useTblAdherentRelatedByEntraineurIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
	{
		return $this
			->joinTblAdherentRelatedByEntraineurId($relationAlias, $joinType)
			->useQuery($relationAlias ? $relationAlias : 'TblAdherentRelatedByEntraineurId', 'TblAdherentQuery');
	}
	 ...
	 * @return    TblAdherentQuery The current query, for fluid interface
	 */
	public function filterByTblAdherentRelatedByIdAdherent($tblAdherent, $comparison = null)
	{
		if ($tblAdherent instanceof TblAdherent) {
			return $this
				->addUsingAlias(TblAdherentPeer::ID_ADHERENT, $tblAdherent->getEntraineurId(), $comparison);
		} elseif ($tblAdherent instanceof PropelCollection) {
			return $this
				->useTblAdherentRelatedByIdAdherentQuery()
				->filterByPrimaryKeys($tblAdherent->getPrimaryKeys())
				->endUse();
		} else {
			throw new PropelException('filterByTblAdherentRelatedByIdAdherent() only accepts arguments of type TblAdherent or PropelCollection');
		}
	}

	/**
	 * Adds a JOIN clause to the query using the TblAdherentRelatedByIdAdherent relation
	 *
	 * @param     string $relationAlias optional alias for the relation
	 * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
	 *
	 * @return    TblAdherentQuery The current query, for fluid interface
	 */
	public function joinTblAdherentRelatedByIdAdherent($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
	{
		$tableMap = $this->getTableMap();
		$relationMap = $tableMap->getRelation('TblAdherentRelatedByIdAdherent');
		...
		if($relationAlias) {
			...
			$this->addJoinObject($join, 'TblAdherentRelatedByIdAdherent');
		}
	...
	/**
	 * Use the TblAdherentRelatedByIdAdherent relation TblAdherent object
	 *
	 * @see       useQuery()
	 *
	 * @param     string $relationAlias optional alias for the relation,
	 ...
	 * @return    TblAdherentQuery A secondary query class using the current class as primary query
	 */
	public function useTblAdherentRelatedByIdAdherentQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
	{
		return $this
			->joinTblAdherentRelatedByIdAdherent($relationAlias, $joinType)
			->useQuery($relationAlias ? $relationAlias : 'TblAdherentRelatedByIdAdherent', 'TblAdherentQuery');
	}
