...
/**
 * This class defines the structure of the 'lnk_sport_adherent' table.
 *
 *
 *
 ...
 */
class LnkSportAdherentTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.LnkSportAdherentTableMap';
	...
	{
		// attributes
		$this->setName('lnk_sport_adherent');
		$this->setPhpName('LnkSportAdherent');
		$this->setClassname('LnkSportAdherent');
