    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class=" entitefiltre fg-toolbar ui-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-corner-tl ui-corner-tr ui-helper-clearfix">
                <form method="POST" action="<?php echo url_for("adherent/mesAdherentsAjax") ?>">        
                    <?php echo $formFilter ?>        
                </form>
            </div>

            <div>
                <table cellpadding="0" cellspacing="0" border="0" id="listeMesAdherents" class="display">
                    <thead>
                        <tr>
...
<script>
    $(document).ready(function() {
        ...
        oTable2 = $('#listeMesAdherents').dataTable(
                {
                    "sDom": 'R<"H"lfr>t<"F"ip<',
                    "bJQueryUI": true,
                    "aaSorting": [[7, "desc"]],
...
//            "bStateSave": true,
                    ...
                    "sAjaxSource": '<?php echo url_for('adherent/mesAdherentsAjax') ?>',
        ...
        $("#listeMesAdherents .even,#listeMesAdherents .odd").live("click", function() {
