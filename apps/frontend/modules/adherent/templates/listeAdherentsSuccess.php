<div >
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class=" entitefiltre fg-toolbar ui-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-corner-tl ui-corner-tr ui-helper-clearfix">
                <form method="POST" action="<?php echo url_for("adherent/listeAdherents") ?>">        
                    <?php echo $formFilter ?>        
                </form>
            </div>
    ...
    <div class="col-md-12 col-xs-12">
        ...
        <div>
            ...
            <a href="<?php echo url_for('adherent/listeAdherents') ?>" class="btn btn-primary"><i class="glyphicon glyphicon-list"></i>Liste des Adherents</a> 
        </div></br>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        oTable2 = $('#listeDesAdherents').dataTable(
                {
                    "sDom": 'R<"H"lfr>t<"F"ip<',
                    "bJQueryUI": true,
                    "aaSorting": [[7, "desc"]],
